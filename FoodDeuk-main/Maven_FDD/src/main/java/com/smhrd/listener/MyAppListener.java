...
public class MyAppListener implements ServletContextListener {
	...
	public Map<Integer, Category> categorys = new HashMap<>();
	public Map<Integer, List<Restaurant>> cat_to_res = new HashMap<>();
	public Map<Integer, Menu> menus = new HashMap<>();
